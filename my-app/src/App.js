...
state = {
  ...
  getWeather = async (latitude,longitude) => {
    const api = await fetch(
      `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=4dec716b9fd87d70b3f8db9dc419ee27`
    );
          ...
          <div className="col-8 d-flex justify-content-center py-5">
            <div className="col-6 app-bg d-flex flex-wrap py-3">
             <div className="col-12">
               <h2 className="text-black m-0">{(this.state.locationName)}</h2>
               <p className="text-black">{(this.state.country)}</p>
             </div>

             <div className=" col-12 mt-auto d-flex">
               <div className="my-auto">
               <h2 className="text-white"><Clock format={'HH:mm:ss'} ticking={true} /></h2>
